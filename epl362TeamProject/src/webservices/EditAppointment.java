...
public class EditAppointment {
	public int edit_appointment(String appointment_id, String client_id, String lawyer_id, String date, String branch_id) throws ParseException {
		...
		try {
			...
			preparedStatement.setString(5, appointment_id);
