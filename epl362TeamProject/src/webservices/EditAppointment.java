...
public class EditAppointment {
	public int edit_appointment(String appointment_id, String client_id, String lawyer_id, String date,int missed, String branch_id) throws ParseException {
		...
		try {
			...
			preparedStatement.setInt(4, missed);
			preparedStatement.setString(5, branch_id);
			preparedStatement.setString(6, appointment_id);
